...
interface ImportSummary {
    success_rate: string;
    return_reason_processed: number;
    [key: string]: any; // For additional summary fields
}

interface IReturnReasonImportResponse {
    return_reasons: {
        inserted_count: number;
        valid_data: ReturnReasonData[];
    };
    duplicated_data: any[];
    ...
    updated_data: ReturnReasonData[];
    updated_records: number;
    valid_records: number;
    valid_data: ReturnReasonData[];
}
export default class ReturnReasonImportResponse implements IReturnReasonImportResponse {
    return_reasons: {
        inserted_count: number;
        valid_data: ReturnReasonData[];
    };
    ...
    valid_records: number;
    valid_data: ReturnReasonData[];
    constructor(data: Partial<IReturnReasonImportResponse> = {}) {
        this.return_reasons = data.return_reasons ?? { inserted_count: 0, valid_data: [] };
        ...
        this.summary = data.summary ?? { success_rate: '', return_reason_processed: 0 };
