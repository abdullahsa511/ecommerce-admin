...
interface IOrderStatusImportResponse {
    order_statuses: {
        inserted_count: number;
        valid_data: OrderStatusData[];
    };
    duplicated_data: any[];
    ...
    updated_data: OrderStatusData[];
    updated_records: number;
    valid_records: number;
    valid_data: OrderStatusData[];
}
export default class OrderStatusImportResponse implements IOrderStatusImportResponse {
    order_statuses: {
        inserted_count: number;
        valid_data: OrderStatusData[];
    };
    ...
    valid_records: number;
    valid_data: OrderStatusData[];
    constructor(data: Partial<IOrderStatusImportResponse> = {}) {
        this.order_statuses = data.order_statuses ?? { inserted_count: 0, valid_data: [] };
        ...
        this.summary = data.summary ?? { success_rate: '', order_status_processed: 0 };
