...
interface ImportSummary {
    success_rate: string;
    taxonomy_processed: number;
    [key: string]: any; // For additional summary fields
}

interface ITaxonomyImportResponse {
    taxonomies: {
        inserted_count: number;
        valid_data: TaxonomyData[];
    };
    duplicated_data: any[];
    ...
    updated_data: TaxonomyData[];
    updated_records: number;
    valid_records: number;
    valid_data: TaxonomyData[];
}

export default class TaxonomyImportResponse implements ITaxonomyImportResponse {
    taxonomies: {
        inserted_count: number;
        valid_data: TaxonomyData[];
    };
    ...
    constructor(data: Partial<ITaxonomyImportResponse> = {}) {
        this.taxonomies = data.taxonomies ?? { inserted_count: 0, valid_data: [] };
        ...
        this.summary = data.summary ?? { success_rate: '', taxonomy_processed: 0 };
