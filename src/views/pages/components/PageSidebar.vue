...
<template>
    <div class="w-2/5 space-y-4">
        ...
        <div class="bg-white rounded-lg shadow-sm" v-if="!isAddMode">
            ...
            <div v-if="bannerMediaExpanded" class="p-6 border-t">
                <!-- Image Preview -->
                <UploadFileFeature v-model:uploadedFilesData="props.page.image_banner" :fb="mediaFb"
        ...
        <div class="bg-white rounded-lg shadow-sm" v-if="!isAddMode">
            ...
            <div v-if="featuredMediaExpanded" class="p-6 border-t">
                <!-- Image Preview -->
                <UploadFileFeature v-model:uploadedFilesData="page.feature_image" :fb="mediaFb"
                ...
                <div class="space-y-6 w-full">
                    ...
                    <div v-if="postOptionsExpanded" class="space-y-6">
                        ...
                        <div class="form-group flex items-center gap-5">
                            ...
                            <Select v-model="props.page.status" :options="pageStatuses" optionLabel="name"
