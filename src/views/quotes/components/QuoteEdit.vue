...
const emit = defineEmits(['update:quote', 'saved', 'editTabUnmunted', 'editTabMounted']);
...
onMounted(async () => {
    emit('editTabMounted');
    if (route.params.id) {
        await quoteStore.fetchQuoteById(route.params.id as string);//string data type
    }
    // if (postTagGroup.value.postTag_group_id) {
    //   selectedGroup.value = postTagGroup.value.postTag_group_id;
    // }

    // console.log('This is Edit pagev  ', quote.value.billingAddress.address);
                ...
                <div class="grid grid-cols-12 gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.organisationCode"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter code" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.organisationName"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter name" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.zohoId"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter Zoho ID" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.terms"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter terms" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.deposit"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter deposit %" />
                    </div>

                    <label class="col-span-12 md:col-span-4 flex items-center text-base">GST %</label>
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.gst"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter GST %" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.billTo"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter bill to" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.shipTo"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter ship to" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.siteContacts"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter site contacts" />
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-8 py-2">
                        <InputText v-model="quote.customerDetails.customerBalance"
                            class="w-full border border-gray-200 rounded-md p-2" placeholder="Enter balance" />
                    </div>
                </div>
            </div>
