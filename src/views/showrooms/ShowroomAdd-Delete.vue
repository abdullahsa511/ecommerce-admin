...
<template>
  <div class="card relative">
    ...
    <Tabs :value="currentRoute" scrollable>
      ...
      <div class="p-6">
        <router-view v-model:showroom="showroom" />
      </div>
    </Tabs>
  </div>
</template>
