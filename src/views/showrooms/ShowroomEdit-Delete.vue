...
const { fb, showroom, sections } = storeToRefs(showroomStore);
...
const items = ref([
    { route: `/showrooms/${props.id}/general`, label: 'General', icon: 'pi pi-home', props: { id: props.id } },
    { route: `/showrooms/${props.id}/sections`, label: 'Sections', icon: 'pi pi-link', props: { id: props.id } }
]);
...
<template>
    <div class="card relative">
        ...
        <Tabs :value="currentRoute" scrollable>
            ...
            <div class="p-6">
                <router-view :id="props.id" v-model:showroom="showroom" @update:showroom="onShowroomUpdated"
