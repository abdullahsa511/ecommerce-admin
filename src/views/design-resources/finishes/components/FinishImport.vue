...
const handleSave = async () => {
  ...
  try {
    ...
    toast.add({ severity: 'success', summary: 'Success', detail: 'Finishes data imported successfully', life: 3000 });
    selectedFile.value = null;
  } catch (error) {
    console.error('Save error:', error);
    toast.add({ severity: 'error', summary: 'Error', detail: error.message || 'Failed to import finishes data', life: 3000 });
  } finally {
    ...
    <div class="bg-white rounded-lg p-6 shadow-md">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div v-if="selectedFile" class="flex flex-col gap-4">
          ...
          <Button icon="pi pi-save" :label="isSaving ? 'Saving...' : 'Import Finishes'" severity="success"
