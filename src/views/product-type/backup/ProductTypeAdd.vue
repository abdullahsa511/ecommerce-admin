...
const saveProductType = async () => {
    try {
        await productTypeStore.createProductType(newProductType.value);
        toast.add({
            severity: 'success',
            summary: 'Success',
        ...
        toast.add({
            severity: 'error',
            summary: 'Error',
            detail: 'Failed to create product type. Please try again.',
            life: 3000
        });
    }
};
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <InputText v-model="newProductType.type" class="text-lg" id="type" type="text" placeholder="Name" />
                    </div>
                </div>
