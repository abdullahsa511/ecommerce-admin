...
const savePaymentStatus = async () => {
    try {
        await paymentStatusStore.createPaymentStatus(paymentStatus.value);
        toast.add({
            severity: 'success',
            summary: 'Success',
            detail: 'Payment status created successfully',
            life: 3000
        });
        ...
        toast.add({
            severity: 'error',
            summary: 'Error',
            detail: 'Failed to create payment status. Please try again.',
            life: 3000
        });
    }
};
