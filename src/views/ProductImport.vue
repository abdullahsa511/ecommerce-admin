...
// Vendor Import
const selectedFileVendors = ref(null);
const isSavingVendors = ref(false);
const vendorsImportResults = ref(null);
const showVendorsResults = ref(false);
    ...
    try {
        ...
        productsImportResults.value = {
            success: {
                ...
                valid_data: response.products ? response.products.valid_data : [],
                ...
                updated_data: response.updated_data ? response.updated_data.map(item => item.data) : [],
            }
        };
...
const clearVendorsResults = () => {
    vendorsImportResults.value = null;
    showVendorsResults.value = false;
};
            ...
            <TabPanels>
                <TabPanel value="0">
                    ...
                    <div v-if="showProductsResults && productsImportResults" class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                            ...
                            <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                <div class="text-2xl font-bold text-purple-600">{{
                                    productsImportResults?.success?.inserted_count ||
                                    0 }}</div>
                        ...
                        <div
                            v-if="productsImportResults?.success?.valid_records > 0 && productsImportResults?.success?.valid_data">
                            <h3 class="text-lg font-semibold mb-4 text-green-700">Valid Records ({{
                                productsImportResults.success.valid_records
                            }})</h3>
                            <DataTable v-model:filters="filters" :value="productsImportResults.success.valid_data"
                                paginator :rows="10" dataKey="product_id" filterDisplay="menu"
                                ...
                                <Column field="specifications_image" header="Specifications Image"
                                ...
                                <Column field="main_image_one_title" header="Main Image One Title"
                                    style="min-width: 12rem" />
                                ...
                                <Column field="main_image_two_title" header="Main Image Two Title"
                                    style="min-width: 12rem" />
                                <Column field="main_image_two_description" header="Main Image Two Description"
                                    style="min-width: 15rem" />
                                <Column field="feature_description" header="Feature Description"
                                    style="min-width: 15rem" />
                                ...
                                <Column field="feature_image_one_title" header="Feature Image One Title"
                                    style="min-width: 12rem" />
                                ...
                                <Column field="feature_image_two_title" header="Feature Image Two Title"
                                    style="min-width: 12rem" />
                                <Column field="feature_image_two_description" header="Feature Image Two Description"
                                    style="min-width: 15rem" />
                                <Column field="feature_image_three" header="Feature Image Three"
                                    style="min-width: 12rem">
                                    <template #body="{ data }">
                ...
                <TabPanel value="1">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importRelatedProductsFile" accept=".csv"
                                :maxFileSize="1000000" @select="handleFileSelectRelatedProducts" :auto="false"
                            ...
                            <div v-if="selectedFileRelatedProducts" class="flex flex-col gap-4">
                                ...
                                <div v-if="isSavingRelatedProducts" class="w-full">
                                    <ProgressBar mode="indeterminate" style="height: 8px" class="w-full" />
                                    <p class="text-sm text-gray-600 mt-2 text-center">Importing related products data...
                                    </p>
                                </div>
                                <Button icon="pi pi-save"
                                    :label="isSavingRelatedProducts ? 'Saving...' : 'Import Related Products'"
                                    severity="success" @click="handleSaveRelatedProducts"
                                    :loading="isSavingRelatedProducts" :disabled="isSavingRelatedProducts"
                                    class="p-button-md" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="showRelatedProductsResults && relatedProductsImportResults"
                        ...
                        <div v-if="relatedProductsImportResults?.success?.invalid_records > 0 && relatedProductsImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="relatedProductsImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.related_product_code']"
                                class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                                ...
                                <Column field="data.related_product_code" header="Related Product Code"
                        ...
                        <div v-if="relatedProductsImportResults?.success?.updated_records > 0 && relatedProductsImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="relatedProductsImportResults.success.updated_data" paginator :rows="10"
                                dataKey="product_code" filterDisplay="menu"
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters"
                                :value="relatedProductsImportResults.success.valid_data" paginator :rows="10"
                                dataKey="product_code" filterDisplay="menu"
                                :globalFilterFields="['product_code', 'related_product_code']" class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                ...
                                <Column field="product_code" header="Product Code" style="min-width: 10rem" />
                                <Column field="related_product_code" header="Related Product Code"
                                    style="min-width: 10rem" />
                            </DataTable>
                        </div>
                    </div>
                ...
                <TabPanel value="2">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importProductsAttributesFile" accept=".csv"
                                :maxFileSize="1000000" @select="handleFileSelectProductsAttributes" :auto="false"
                                chooseLabel="Select CSV File" />
                            <div v-if="selectedFileProductsAttributes" class="flex flex-col gap-4">
                                ...
                                <Button icon="pi pi-save"
                                    :label="isSavingProductsAttributes ? 'Saving...' : 'Import Attributes'"
                                    severity="success" @click="handleSaveProductsAttributes"
                                    :loading="isSavingProductsAttributes" :disabled="isSavingProductsAttributes"
                                    class="p-button-md" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="showProductsAttributesResults && productsAttributesImportResults"
                        ...
                        <div v-if="productsAttributesImportResults?.success?.invalid_records > 0 && productsAttributesImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsAttributesImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.language_code', 'data.value']"
                                class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                        ...
                        <div v-if="productsAttributesImportResults?.success?.updated_records > 0 && productsAttributesImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsAttributesImportResults.success.updated_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.language_code', 'data.value']"
                                class="th-table">
                                <template #header>
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsAttributesImportResults.success.valid_data" paginator :rows="10"
                                dataKey="product_code" filterDisplay="menu"
                                :globalFilterFields="['product_code','language_code', 'value']"
                                class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                ...
                <TabPanel value="3">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importProductsVariantsFile" accept=".csv"
                                :maxFileSize="1000000" @select="handleFileSelectProductsVariants" :auto="false"
                                chooseLabel="Select CSV File" />
                            <div v-if="selectedFileProductsVariants" class="flex flex-col gap-4">
                                ...
                                <div v-if="isSavingProductsVariants" class="w-full">
                                    <ProgressBar mode="indeterminate" style="height: 8px" class="w-full" />
                                    <p class="text-sm text-gray-600 mt-2 text-center">Importing product variants data...
                                    </p>
                                </div>
                                <Button icon="pi pi-save"
                                    :label="isSavingProductsVariants ? 'Saving...' : 'Import Variants'"
                                    severity="success" @click="handleSaveProductsVariants"
                                    :loading="isSavingProductsVariants" :disabled="isSavingProductsVariants"
                                    class="p-button-md" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="showProductsVariantsResults && productsVariantsImportResults"
                        ...
                        <div v-if="productsVariantsImportResults?.success?.invalid_records > 0 && productsVariantsImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsVariantsImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.variant_product_code']"
                                class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                                ...
                                <Column field="data.variant_product_code" header="Variant Product Code"
                                    style="min-width: 10rem">
                                    <template #body="{ data }">
                        ...
                        <div v-if="productsVariantsImportResults?.success?.updated_records > 0 && productsVariantsImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsVariantsImportResults.success.updated_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.variant_product_code']"
                                class="th-table">
                                <template #header>
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsVariantsImportResults.success.valid_data" paginator :rows="10"
                                dataKey="product_code" filterDisplay="menu"
                                ...
                                <Column field="product_code" header="Product Code" style="min-width: 10rem" />
                                <Column field="variant_product_code" header="Variant Product Code"
                                    style="min-width: 10rem" />
                            </DataTable>
                        </div>
                    </div>
                ...
                <TabPanel value="4">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importProductsOptionsFile" accept=".csv"
                                :maxFileSize="1000000" @select="handleFileSelectProductsOptions" :auto="false"
                                chooseLabel="Select CSV File" />
                            <div v-if="selectedFileProductsOptions" class="flex flex-col gap-4">
                                ...
                                <Button icon="pi pi-save"
                                    :label="isSavingProductsOptions ? 'Saving...' : 'Import Options'" severity="success"
                                    @click="handleSaveProductsOptions" :loading="isSavingProductsOptions"
                    ...
                    <div v-if="showProductsOptionsResults && productsOptionsImportResults"
                        ...
                        <div v-if="productsOptionsImportResults?.success?.invalid_records > 0 && productsOptionsImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsOptionsImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                ...
                                <Column field="data.meta_description" header="Meta Description"
                                    style="min-width: 15rem">
                                    <template #body="{ data }">
                        ...
                        <div v-if="productsOptionsImportResults?.success?.updated_records > 0 && productsOptionsImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsOptionsImportResults.success.updated_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.option_code', 'data.type', 'data.name', 'data.value', 'data.meta_description', 'data.required']"
                                class="th-table">
                                <template #header>
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsOptionsImportResults.success.valid_data" paginator :rows="10"
                                dataKey="product_code" filterDisplay="menu"
                ...
                <TabPanel value="5">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importProductsImagesFile" accept=".csv"
                                :maxFileSize="1000000" @select="handleFileSelectProductsImages" :auto="false"
                                chooseLabel="Select CSV File" />
                            <div v-if="selectedFileProductsImages" class="flex flex-col gap-4">
                                ...
                                <Button icon="pi pi-save"
                                    :label="isSavingProductsImages ? 'Saving...' : 'Import Images'" severity="success"
                                    @click="handleSaveProductsImages" :loading="isSavingProductsImages"
                                    :disabled="isSavingProductsImages" class="p-button-md" />
                            </div>
                        </div>
                    </div>
                    <!-- Products Images Import Results Section -->
                    <div v-if="showProductsImagesResults && productsImagesImportResults"
                        class="bg-white rounded-lg p-6 shadow-md">
                        <div class="flex justify-between items-center mb-6">
                        ...
                        <div v-if="productsImagesImportResults?.success?.invalid_records > 0 && productsImagesImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsImagesImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                ...
                                <Column field="data.image_link" header="Image Link" style="min-width: 15rem">
                                    <template #body="{ data }">
                                        <a :href="data.data.image_link" target="_blank"
                        ...
                        <div v-if="productsImagesImportResults?.success?.updated_records > 0 && productsImagesImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsImagesImportResults.success.updated_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.image_link', 'data.image', 'data.sort_order', 'data.status', 'data.way_point']"
                                class="th-table">
                                <template #header>
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters" :value="productsImagesImportResults.success.valid_data"
                ...
                <TabPanel value="6">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <p class="text-gray-600 mb-4">Upload a CSV file to start importing product digital assets data
                        </p>
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importProductsDigitalAssetsFile" accept=".csv"
                                :maxFileSize="1000000" @select="handleFileSelectProductsDigitalAssets" :auto="false"
                                chooseLabel="Select CSV File" />
                            <div v-if="selectedFileProductsDigitalAssets" class="flex flex-col gap-4">
                                ...
                                <div v-if="isSavingProductsDigitalAssets" class="w-full">
                                    <ProgressBar mode="indeterminate" style="height: 8px" class="w-full" />
                                    <p class="text-sm text-gray-600 mt-2 text-center">Importing product digital assets
                                        data...
                                    </p>
                                </div>
                                <Button icon="pi pi-save"
                    ...
                    <div v-if="showProductsDigitalAssetsResults && productsDigitalAssetsImportResults"
                        ...
                        <div v-if="productsDigitalAssetsImportResults?.success?.invalid_records > 0 && productsDigitalAssetsImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsDigitalAssetsImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                ...
                                <Column field="data.digital_asset_code" header="Digital Asset Code"
                                    style="min-width: 12rem">
                                    <template #body="{ data }">
                        ...
                        <div v-if="productsDigitalAssetsImportResults?.success?.updated_records > 0 && productsDigitalAssetsImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsDigitalAssetsImportResults.success.updated_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.digital_asset_code']" class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters"
                                :value="productsDigitalAssetsImportResults.success.valid_data" paginator :rows="10"
                                dataKey="product_code" filterDisplay="menu"
                                ...
                                <Column field="product_code" header="Product Code" style="min-width: 10rem" />
                                <Column field="digital_asset_code" header="Digital Asset Code"
                                    style="min-width: 12rem" />
                            </DataTable>
                        </div>
                    </div>
                ...
                <TabPanel value="7">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        <h2 class="text-xl font-semibold mb-2">Import Product Tags or Categories CSV data</h2>
                        <p class="text-gray-600 mb-4">Upload a CSV file to start importing product tags or categories
                            data
                        </p>
                        <div class="flex flex-col gap-4">
                            ...
                            <div v-if="selectedFileProductsTags" class="flex flex-col gap-4">
                                ...
                                <div v-if="isSavingProductsTags" class="w-full">
                                    <ProgressBar mode="indeterminate" style="height: 8px" class="w-full" />
                                    <p class="text-sm text-gray-600 mt-2 text-center">Importing product tags or
                                        categories
                                        data...</p>
                                </div>
                    ...
                    <div v-if="showProductsTagsResults && productsTagsImportResults"
                        class="bg-white rounded-lg p-6 shadow-md">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-xl font-semibold">Products Tags or Categories Import Results</h2>
                            <Button icon="pi pi-times" label="Clear Results" severity="secondary" outlined
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                            <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                                <div class="text-2xl font-bold text-blue-600">{{
                                    productsTagsImportResults?.success?.total_records
                                    || 0 }}
                                </div>
                                <div class="text-sm text-blue-800">Total Records</div>
                            </div>
                            <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                <div class="text-2xl font-bold text-green-600">{{
                                    productsTagsImportResults?.success?.valid_records
                                    || 0 }}
                                </div>
                                <div class="text-sm text-green-800">Valid Records</div>
                            </div>
                            <div class="bg-red-50 p-4 rounded-lg border border-red-200">
                                <div class="text-2xl font-bold text-red-600">{{
                                    productsTagsImportResults?.success?.invalid_records
                                    || 0 }}
                                </div>
                                <div class="text-sm text-red-800">Invalid Records</div>
                            </div>
                        ...
                        <div v-if="productsTagsImportResults?.success?.invalid_records > 0 && productsTagsImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters" :value="productsTagsImportResults.success.invalid_data"
                                ...
                                <Column field="data.taxonomy_item_code" header="Taxonomy Item Code"
                                    style="min-width: 12rem">
                                    <template #body="{ data }">
                        ...
                        <div v-if="productsTagsImportResults?.success?.updated_records > 0 && productsTagsImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters" :value="productsTagsImportResults.success.updated_data"
                                paginator :rows="10" dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.product_code', 'data.taxonomy_item_code']" class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters" :value="productsTagsImportResults.success.valid_data"
                                paginator :rows="10" dataKey="product_code" filterDisplay="menu"
                                ...
                                <Column field="product_code" header="Product Code" style="min-width: 10rem" />
                                <Column field="taxonomy_item_code" header="Taxonomy Item Code"
                                    style="min-width: 12rem" />
                            </DataTable>
                        </div>
                    </div>
                ...
                <TabPanel value="8">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div v-if="selectedFileManufacturers" class="flex flex-col gap-4">
                                ...
                                <Button icon="pi pi-save"
                                    :label="isSavingManufacturers ? 'Saving...' : 'Import Manufacturers'"
                    ...
                    <div v-if="showManufacturersResults && manufacturersImportResults && manufacturersImportResults.success.form_status === 'manufacturer'"
                        ...
                        <div v-if="manufacturersImportResults?.success?.invalid_records > 0 && manufacturersImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="manufacturersImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                ...
                                <Column field="data.image" header="Image" style="min-width: 12rem">
                                    <template #body="{ data }">
                                        <img :src="data.data.image" alt="Manufacturer Image"
                        ...
                        <div v-if="manufacturersImportResults?.success?.updated_records > 0 && manufacturersImportResults?.success?.updated_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="manufacturersImportResults.success.updated_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.manufacturer_code', 'data.name']" class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                        ...
                        <div
                            ...
                            <DataTable v-model:filters="filters" :value="manufacturersImportResults.success.valid_data"
                                paginator :rows="10" dataKey="manufacturer_code" filterDisplay="menu"
                ...
                <TabPanel value="9">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <p class="text-gray-600 mb-4">Upload a CSV file to import Vendors data.</p>
                        <div class="flex flex-col gap-4">
                            <FileUpload mode="basic" name="importManufacturersFile" accept=".csv" :maxFileSize="1000000"
                                @select="handleFileSelectManufacturers" :auto="false" chooseLabel="Select CSV File" />
                            ...
                            <div v-if="selectedFileManufacturers" class="flex flex-col gap-4">
                                ...
                                <div v-if="isSavingManufacturers" class="w-full">
                                    <ProgressBar mode="indeterminate" style="height: 8px" class="w-full" />
                                    <p class="text-sm text-gray-600 mt-2 text-center">Importing Vendors data...</p>
                                </div>
                                <Button icon="pi pi-save"
                                    :label="isSavingManufacturers ? 'Saving...' : 'Import Vendors'" severity="success"
                                    @click="handleSaveManufacturers" :loading="isSavingManufacturers"
                                    :disabled="isSavingManufacturers" class="p-button-md" />
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Manufacturers Import Results -->
                    <div v-if="showManufacturersResults && manufacturersImportResults && manufacturersImportResults.success.form_status === 'vendor'"
                        class="bg-white rounded-lg p-6 shadow-md">
                        <div class="flex justify-between items-center mb-6">
                        ...
                        <div v-if="manufacturersImportResults?.success?.invalid_records > 0 && manufacturersImportResults?.success?.invalid_data"
                            ...
                            <DataTable v-model:filters="filters"
                                :value="manufacturersImportResults.success.invalid_data" paginator :rows="10"
                                dataKey="row" filterDisplay="menu"
                                :globalFilterFields="['data.vendor_code', 'data.name']" class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                                            @click="clearFilter()" />
                                ...
                                <template #empty> No invalid vandor records found. </template>
                                <Column field="row" header="Row" style="min-width: 6rem">
                                    <template #body="{ data }">{{ data.row }}</template>
                                </Column>
                                <Column field="data.vendor_code" header="Code" style="min-width: 10rem">
                                    <template #body="{ data }">{{ data.data.vendor_code }}</template>
                                </Column>
                                <Column field="data.name" header="Name" style="min-width: 12rem">
                                    <template #body="{ data }">{{ data.data.name }}</template>
                                </Column>
                                ...
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                                            @click="clearFilter()" />
                                        <InputText v-model="filters['global'].value"
                                            placeholder="Search updated vandor records..." />
                                    </div>
                                </template>
                                <template #empty> No updated vandor records found. </template>
                                <Column field="data.vendor_code" header="Code" style="min-width: 10rem">
                                    <template #body="{ data }">{{ data.data.vendor_code }}</template>
                                </Column>
                                <Column field="data.name" header="Name" style="min-width: 12rem" />
                        ...
                        <div
                            ...
                            <h3 class="text-lg font-semibold mb-4 text-green-700">Valid Records ({{
                                manufacturersImportResults.success.valid_records }})</h3>
                            <DataTable v-model:filters="filters" :value="manufacturersImportResults.success.valid_data"
                                paginator :rows="10" dataKey="vendor_code" filterDisplay="menu"
                                :globalFilterFields="['vendor_code', 'name']" class="th-table">
                                <template #header>
                                    <div class="flex justify-between items-center">
                                        <Button type="button" icon="pi pi-filter-slash" label="Clear" outlined
                                            @click="clearFilter()" />
                                ...
                                <template #empty> No valid vandor records found. </template>
