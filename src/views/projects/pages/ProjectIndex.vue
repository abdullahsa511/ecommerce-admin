...
const deleteProject = async (data: any) => await projectStore.deleteProject(data.project_id);
           ...
           <Column field="image_thumb" header="Thumbnail" style="min-width: 8rem">
            ...
            <Column header="Actions" :exportable="false" style="min-width: 8rem">
                <template #body="{ data }">
                    <div class="flex gap-2">
                        <Button 
                            :icon="fb.loading['project.update.'+data.project_id] ? 'pi pi-spinner pi-spin' : 'pi pi-pencil'"
                            :loading="fb.loading['project.update.'+data.project_id]"
                            rounded outlined 
                            severity="success" 
                            class="mr-2" 
