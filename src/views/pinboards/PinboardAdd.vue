...
const items = ref([
    { route: '/pinboards/add/overview', label: 'Pinboard List', icon: 'pi pi-file' },
    { route: '/pinboards/add/overview', label: 'Pinboard Add', icon: 'pi pi-file' },
    { route: '/pinboards/add/overview', label: 'Pinboard Edit', icon: 'pi pi-file' },
    { route: '/pinboards/add/items', label: 'Pinboard Items', icon: 'pi pi-list' },
    { route: '/pinboards/add/items', label: 'Import Items', icon: 'pi pi-list' },
...
<template>
    <div class="card relative">
        ...
        <Tabs :value="currentRoute" scrollable>
            ...
            <div class="p-6">
                <router-view :pinboard="pinboard" v-model.pinboard="pinboard" @saved="onPinboardSaved"/>
            </div>
        </Tabs>
    </div>
</template>
