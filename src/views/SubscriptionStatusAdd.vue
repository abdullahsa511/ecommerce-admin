...
const saveSubscriptionStatus = async () => {
    try {
        await subscriptionStatusStore.createSubscriptionStatus(subscriptionStatus.value);
        toast.add({
            severity: 'success',
            summary: 'Success',
        ...
        toast.add({
            severity: 'error',
            summary: 'Error',
            detail: 'Failed to create subscription status. Please try again.',
            life: 3000
        });
    }
};
