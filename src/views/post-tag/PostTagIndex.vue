...
const items = ref([
  { route: `/posts/tags/list`, label: 'Post Tags', icon: 'pi pi-home' },
  { route: `/posts/tags/add`, label: 'Add', icon: 'pi pi-link' },
  { route: `/posts/tags/import`, label: 'Import', icon: 'pi pi-link' },
]);
