            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="firstname" type="text" placeholder="First Name" v-model="newAdmin.first_name" />
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-2">
                    <label for="lastname" class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0">Last Name</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="lastname" type="text" placeholder="Last Name" v-model="newAdmin.last_name" />
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-2">
                    <label for="phone" class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0">Phone Number</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="phone" type="text" placeholder="Phone Number" v-model="newAdmin.phone_number" />
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-2">
                    <label for="website" class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0">Website</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="website" type="text" placeholder="Website" v-model="newAdmin.url" />
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-2">
                    <label for="username" class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0">Username</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="username" type="text" placeholder="Username" v-model="newAdmin.username" />
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-2">
                    <label for="email" class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0">Email</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="email" type="text" placeholder="Email" v-model="newAdmin.email" />
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-2">
                    <label for="displayname" class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0">Display Name</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="displayname" type="text" placeholder="Display Name" v-model="newAdmin.display_name" />
                    </div>
                </div>
        ...
        <div class="md:w-1/2">
            ...
            <div class="card flex flex-col gap-6">
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <Textarea class="w-full text-lg" placeholder="Biography" :autoResize="true" rows="3" cols="30" v-model="newAdmin.bio" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-2 ">
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <Select class="w-full text-lg" v-model="newAdmin.status" :options="dropdownStatusValues" optionLabel="name" optionValue="code" placeholder="Select" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="w-full text-lg" id="password" type="password" placeholder="Password" v-model="newAdmin.password" />
                    </div>
                </div>
