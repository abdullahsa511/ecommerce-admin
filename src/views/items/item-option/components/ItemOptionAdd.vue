...
const uploadItemOptionImages = async (event: any) => {
    try {
        ...
        await itemOptionStore.uploadItemOptionImages(files, 'image', itemOption.value.item_option_id);
    } catch (error) {
...
const deleteItemOptionImages = async (file: any) => {
    try {
        await itemOptionStore.deleteItemOptionImages(file, itemOption.value.item_option_id);
...
<template>
    <div class="flex flex-col gap-6">
        ...
        <div class="loading-overlay border-2" v-if="fb.loading['itemOption.create']">
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="sm:w-full md:w-3/5 space-y-4">
                <h3 class="text-lg font-medium border-b border-gray-200 pb-2">Add Item Option</h3>
                <div class="grid grid-cols-12 gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        ...
                        <Message v-if="fb.errors?.['itemOption.create']?.option_name" severity="error" size="small"
                            itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.option_name" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <AutoComplete ref="itemAutocomplete" :suggestions="itemSuggestions" @complete="onItemInput"
                            ...
                            :class="{ 'p-invalid': fb.errors?.['itemOption.create']?.item_id }" />
                        <Message v-if="fb.errors?.['itemOption.create']?.item_id" severity="error" size="small"
                            itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.item_id" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <AutoComplete ref="productAutocomplete" :suggestions="productSuggestions"
                            ...
                            inputClass="w-full !rounded-md !border !border-gray-200 !shadow-none !focus:ring-0"
                            :class="{ 'p-invalid': fb.errors?.['itemOption.create']?.product_id }" />
                        <Message v-if="fb.errors?.['itemOption.create']?.product_id" severity="error" size="small"
                            itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.product_id" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <AutoComplete ref="productVariantAutocomplete" :suggestions="productVariantSuggestions"
                            ...
                            placeholder="Type for autocomplete" class="w-full related-products-autocomplete"
                            inputClass="w-full !rounded-md !border !border-gray-200 !shadow-none !focus:ring-0"
                            :class="{ 'p-invalid': fb.errors?.['itemOption.create']?.product_variant_id }" />
                        <Message v-if="fb.errors?.['itemOption.create']?.product_variant_id" severity="error"
                            size="small" itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.product_variant_id" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <AutoComplete ref="optionGroupAutocomplete" :suggestions="optionGroupSuggestions"
                            ...
                            inputClass="w-full !rounded-md !border !border-gray-200 !shadow-none !focus:ring-0"
                            :class="{ 'p-invalid': fb.errors?.['itemOption.create']?.product_variant_id }" />
                        <Message v-if="fb.errors?.['itemOption.create']?.product_option_group_id" severity="error"
                            size="small" itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.product_option_group_id"
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <AutoComplete ref="optionAutocomplete" :suggestions="optionSuggestions"
                            ...
                            class="w-full related-products-autocomplete"
                            inputClass="w-full !rounded-md !border !border-gray-200 !shadow-none !focus:ring-0"
                            :class="{ 'p-invalid': fb.errors?.['itemOption.create']?.product_option_id }" />
                        <Message v-if="fb.errors?.['itemOption.create']?.product_option_id" severity="error"
                            size="small" itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.product_option_id" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        ...
                        <Message v-if="fb.errors?.['itemOption.create']?.type_id" severity="error" size="small"
                            itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.type_id" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <InputNumber v-model="itemOption.required" :min="0" :max="1"
                            class="w-full text-lg border border-gray-200 rounded-md p-2" placeholder="Enter required"
                            :class="{ 'p-invalid': fb.errors?.['itemOption.create']?.required }" />
                        <Message v-if="fb.errors?.['itemOption.create']?.required" severity="error" size="small"
                            itemOption="title">
                            <span v-for="error in fb.errors?.['itemOption.create']?.required" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
            ...
            <div class="sm:w-full md:w-2/5 space-y-4">
                ...
                <div class="grid grid-cols-12 gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-12 py-2">
                        <UploadFileFeature v-model:uploadedFilesData="itemOption.image" :fb="fb" :property="'image'"
                            @upload="uploadItemOptionImages($event)"
                            @removeUploadedFile="deleteItemOptionImages($event)"
                            class="w-full text-lg border border-gray-200 rounded-md p-2"
