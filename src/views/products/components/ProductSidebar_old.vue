...
import { SidebarMedia, ProductVariant } from '@/models/Product.ts';
...
//     variants: props.productVariants[0]?.variant_name || '',
// });
...
onMounted(() => {
    setTimeout(() => {
        defaultVariantName.value = props.productVariants[0]?.variant_name || '';
                    ...
                    <div v-if="postOptionsExpanded" class="space-y-6">
                        ...
                        <div class="flex flex-wrap w-full gap-4">
                            ...
                            @click="defaultVariantName = variant.variant_name">
                                ...
                                <Badge class="mt-1" v-if="defaultVariantName === variant.variant_name" severity="contrast">
                                    Selected
                                </Badge>
                            </div>
                                        ...
                                        <div class="flex justify-between space-x-4 w-full">
                                            <div class="flex flex-col items-start relative pb-5 flex-1">
                                                ...
                                                <Badge
                                                    ...
                                                    {{ selectedOptions.heightRange === 'Low-Height Range' ? 'Selected' : '$0' }}</Badge>
                                            </div>
                                            ...
                                            <div class="flex flex-col items-center relative flex-1">
                                                <a :class="['p-3', 'border', 'text-sm', 'font-semibold', 'cursor-pointer', 'rounded-none', 'w-full', 'block', 'text-center',
                                                    ...
                                                    @click="selectedItems($event, 'Standard-Height Range', 'heightRange')">
                                                ...
                                                <Badge
                                                    ...
                                                    {{ selectedOptions.heightRange === 'Standard-Height Range' ? 'Selected' : '$0' }}
                                                </Badge>
                                            </div>
                                            ...
                                            <div class="flex flex-col items-start relative pb-5 flex-1">
                                                ...
                                                <Badge
                                                    ...
                                                    {{ selectedOptions.heightRange === 'High-Height Range' ? 'Selected' : '+$65' }}
                                                </Badge>
                                            </div>
                                        </div>
