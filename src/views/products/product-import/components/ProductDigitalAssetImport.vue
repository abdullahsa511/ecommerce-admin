    ...
    <div class="bg-white rounded-lg p-6 shadow-md">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div v-if="selectedFileProductsDigitalAssets" class="flex flex-col gap-4">
                ...
                <Button icon="pi pi-save" :label="isSavingProductsDigitalAssets ? 'Saving...' : 'Import Digital Assets'"
                    severity="success" @click="handleSaveProductsDigitalAssets" :loading="isSavingProductsDigitalAssets"
                    :disabled="isSavingProductsDigitalAssets" class="p-button-md" />
            </div>
        </div>
    </div>
