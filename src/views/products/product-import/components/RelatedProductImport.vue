...
<template>
    ...
    <div v-if="showRelatedProductsResults && relatedProductsImportResults" class="bg-white rounded-lg p-6 shadow-md">
        ...
        <div v-if="relatedProductsImportResults?.success?.invalid_records > 0 && relatedProductsImportResults?.success?.invalid_data"
            ...
            <DataTable v-model:filters="filters" :value="relatedProductsImportResults.success.invalid_data" paginator
        ...
        <div v-if="relatedProductsImportResults?.success?.updated_records > 0 && relatedProductsImportResults?.success?.updated_data"
            ...
            <DataTable v-model:filters="filters" :value="relatedProductsImportResults.success.updated_data" paginator
