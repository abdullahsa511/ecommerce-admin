...
const { fb, product, productOptionGroups, productVariants } = storeToRefs(productStore);
...
onMounted(async () => {
  ...
  selectedVariant.value = variant.value;
  // console.log('variant onMounted', variant.value);}
});
</script>
...
<template>
  <div class="flex flex-col md:flex-row gap-2">
    ...
    <div
      ...
      <VariantForm v-show="true" :productVariants="productVariantsArray"
