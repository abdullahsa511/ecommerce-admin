...
const goToVendorList = () => {
    router.push('/ecommerce/products/vendors');
};
...
<template>
    <div class="flex justify-end gap-2 mb-6">
        <Button icon="pi pi-arrow-left" label="Vendor List" severity="secondary" @click="goToVendorList"
            class="p-button-md" />
        <Button icon="pi pi-save" label="Save" severity="primary" @click="saveVendor" class="p-button-md" />
    </div>
            ...
            <div class="flex flex-col gap-6">
                <div class="grid grid-cols-12 gap-2">
                    <label for="vendor_code"
                        class="flex items-center col-span-12 mb-2 md:col-span-2 md:mb-0 text-lg">Code</label>
                    <div class="col-span-12 md:col-span-10">
                        <InputText class="text-lg" id="vendor_code" type="text" placeholder="Vendor code" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-12 md:col-span-10 flex flex-col items-start">
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center">
                            <img v-if="avatarFile" :src="URL.createObjectURL(avatarFile)" alt="Avatar"
