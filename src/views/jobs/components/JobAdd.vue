...
const emit = defineEmits(['update:job', 'saved']);
    ...
    <div class="flex flex-col gap-6">
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="sm:w-full md:w-3/5 space-y-4">
                <h3 class="text-lg font-medium border-b border-gray-200 pb-2">Add Job</h3>
                <div class="grid grid-cols-12 gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <InputText v-model="job.job_title"
                            ...
                            :class="{ 'p-invalid': fb.errors?.['job.create']?.job_title }" />
                        <Message v-if="fb.errors?.['job.create']?.job_title" severity="error" size="small"
                            variant="title">
                            <span v-for="error in fb.errors?.['job.create']?.job_title" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <InputText v-model="job.reference"
                            ...
                            :class="{ 'p-invalid': fb.errors?.['job.create']?.reference }" />
                        <Message v-if="fb.errors?.['job.create']?.reference" severity="error" size="small"
                            variant="title">
                            <span v-for="error in fb.errors?.['job.create']?.reference" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <Select v-model="job.company" :options="companyValues" optionLabel="name" optionValue="code"
                            ...
                            :class="{ 'p-invalid': fb.errors?.['job.create']?.company }" />
                        <Message v-if="fb.errors?.['job.create']?.company" severity="error" size="small"
                            variant="title">
                            <span v-for="error in fb.errors?.['job.create']?.company" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
                    ...
                    <div class="col-span-12 md:col-span-9 xl:col-span-10 py-2">
                        <Select v-model="job.type" :options="typeValues" optionLabel="name" optionValue="code"
                            ...
                            :class="{ 'p-invalid': fb.errors?.['job.create']?.type }" />
                        <Message v-if="fb.errors?.['job.create']?.type" severity="error" size="small"
                            variant="title">
                            <span v-for="error in fb.errors?.['job.create']?.type" :key="error"
                                class="flex flex-col">
                                {{ error }}
                            </span>
                        </Message>
